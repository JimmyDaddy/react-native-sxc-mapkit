...
public class Config implements Parcelable
{
    ...
    public static final int ANDROID_BAIDU_LOCATION = 0; //百度
    public static final int ANDROID_AMAP_LOCATION = 1; // 高德
    ...
    private Integer locationClient = ANDROID_BAIDU_LOCATION;
    ...
    public Integer getLocationClient() {
        return locationClient;
    }

    public void setLocationClient(Integer locationClient) {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(getLocationClient());
        Bundle bundle = new Bundle();
        bundle.putSerializable("httpHeaders", getHttpHeaders());
        bundle.putSerializable("params", getParams());
    ...
    private Config(Parcel in) {
        ...
        setLocationClient(in.readInt());
        Bundle bundle = in.readBundle();
        setHttpHeaders((HashMap<String, String>) bundle.getSerializable("httpHeaders"));
        setParams((HashMap<String, String>) bundle.getSerializable("params"));
    }
    ...
    public void setParams(JSONObject params) throws JSONException {
        ...
        while (it.hasNext()) {
            String key = (String) it.next();
            this.params.put(key, params.getString(key));
        }
    }
    ...
    public String toString () {
        return new StringBuffer()
                ...
                .append(" params=").append(getParams().toString())
                .append(" locationClient").append(getLocationClient().toString())
                .append("]")
                .toString();
    }
    ...
    public static Config fromJSONObject (JSONObject jObject) throws JSONException {
        ...
        config.setLocationClient(jObject.optInt("locationClient", config.getLocationClient()));
