...
public class SQLiteConfigurationDAO implements ConfigurationDAO {
  ...
  public Config retrieveConfiguration() throws JSONException {
    ...
    String[] columns = {
            ...
            ConfigurationEntry.COLUMN_NAME_LOCATION_CLIENT,
    };
  ...
  private Config hydrate(Cursor c) throws JSONException {
    ...
    config.setParams(new JSONObject(c.getString(c.getColumnIndex(ConfigurationEntry.COLUMN_NAME_PARAMS))));
    config.setLocationClient(c.getInt(c.getColumnIndex(ConfigurationEntry.COLUMN_NAME_LOCATION_CLIENT)));
  ...
  private ContentValues  getContentValues(Config config) throws NullPointerException {
    ...
    values.put(ConfigurationEntry.COLUMN_NAME_PARAMS, new JSONObject(config.getParams()).toString());
    values.put(ConfigurationEntry.COLUMN_NAME_LOCATION_CLIENT, config.getLocationClient());
