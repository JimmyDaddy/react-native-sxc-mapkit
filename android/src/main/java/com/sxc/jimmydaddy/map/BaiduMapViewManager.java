...
public class BaiduMapViewManager extends ViewGroupManager<MapView> {
    ...
    public void setAllGesturesEnabled(MapView mapView, boolean enable){
        settings.setAllGesturesEnabled(enable);
    }

    @ReactProp(name = "showMapScaleBar")
    public void setShowScaleControl(MapView mapView, boolean showScaleControl) {
        mapView.showScaleControl(showScaleControl);
    }

//    @ReactProp(name="compassEnabled")
//    public void setCompassEnabled(MapView mapView, boolean compassEnabled) {
...
//    }
    ...
    public void setOverlookingGesturesEnabled(MapView mapView, boolean overlookingGesturesEnabled) {
        settings.setOverlookingGesturesEnabled(overlookingGesturesEnabled);
    }

    @ReactProp(name="rotateEnabled")
    public void setRotateGesturesEnabled(MapView mapView, boolean rotateGesturesEnabled) {
        settings.setRotateGesturesEnabled(rotateGesturesEnabled);
    }

    @ReactProp(name="scrollEnabled")
    public void setScrollGesturesEnabled(MapView mapView, boolean scrollGesturesEnabled) {
        settings.setScrollGesturesEnabled(scrollGesturesEnabled);
    }

    @ReactProp(name="zoomEnabledWithTap")
    public void setZoomGesturesTapEnabled(MapView mapView, boolean zoomGesturesEnabled) {
        settings.setZoomGesturesEnabled(zoomGesturesEnabled);
    }

    @ReactProp(name="zoomEnabled")
    public void setZoomGesturesEnabled(MapView mapView, boolean zoomEnabled) {
        settings.setZoomGesturesEnabled(zoomEnabled);
    }
